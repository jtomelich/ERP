...
export class OrdenCompraService {
    //uso de prisma
        ...
        async getDato(id:any){
            try{
                let dato = await this.prisma.ordencompra.findFirst({
                    where: {id:id}
                });
        ...
        //Metodo para agregar
        async addDatos(dto: OrdencompraDto){
            try{
                
                await this.prisma.ordencompra.create({
                    data:{
        ...
        //editar
        async updateDatos(id:any, dto:OrdencompraDto){
            try{
                //verifica si exite
                let existing = await this.prisma.ordencompra.findFirst({
                    where: {id: id}
                });
