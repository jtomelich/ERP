...
export class SucursalService {
    //uso de prisma
        ...
        async getDato(id:any){
            try{
                let dato = await this.prisma.sucursal.findFirst({
                    where: {id:id}
                });
        ...
        //Metodo para agregar
        async addDatos(dto: SucursalDto){
            try{
                //Validar si existe
                let existing = await this.prisma.sucursal.findFirst({
        ...
        //editar
        async updateDatos(id:any, dto:SucursalDto){
            try{
                //verifica si exite
                let existing = await this.prisma.sucursal.findFirst({
                    where: {id: id}
